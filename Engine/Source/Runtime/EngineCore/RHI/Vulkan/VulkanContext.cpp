...
vk::raii::ShaderModule VulkanContext::CreateShaderModule(const std::vector<char>& code) const
{
...
uint32_t VulkanContext::chooseSwapMinImageCount(vk::SurfaceCapabilitiesKHR const& surfaceCapabilities)
{
