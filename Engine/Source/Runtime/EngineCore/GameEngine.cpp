...
void GameEngine::InitializeVulkan()
{
    CreateInstance();
    SetupDebugMessenger();
    CreateSurface();
...
void GameEngine::CreateImageViews()
{
...
void GameEngine::CreateGraphicsPipeline()
{
...
void GameEngine::CreateCommandPool()
{
...
void GameEngine::CreateSyncObjects()
{
...
void GameEngine::CleanupSwapChain()
{
    VulkanSwapChainImageViews.clear();
    VulkanSwapChain = nullptr;
}

void GameEngine::RecreateSwapChain()
{
...
void GameEngine::recordCommandBuffer(uint32_t imageIndex)
{
...
void GameEngine::transition_image_layout(
    uint32_t                imageIndex,
...
vk::Extent2D GameEngine::chooseSwapExtent(const vk::SurfaceCapabilitiesKHR& capabilities)
{
